...
const Alasan = () => {
  return (
    <div className="flex w-full py-10 px-20 justify-center items-center bg-[#98957f]">
      <div className="flex flex-col justify-center items-center gap-8">
        <h1 className="text-2xl text-white font-bold text-center">Alasan membeli di toko kami</h1>
        <div className="flex flex-row gap-4 justify-center items-center flex-wrap">
          <div className="flex justify-center items-center flex-col bg-white rounded-xl text-black p-6 text-center gap-2 w-full sm:w-[340px] h-[120px] text-sm font-semibold">
